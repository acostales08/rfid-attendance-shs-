...
import SubjectForm from '../../Form/academics/subjectForm'
...
const SubjectContent = () => {
  ...
  const displayData = async (type) => {
    try {
      const subject = await fetchData(type="subject")
  ...
  return (
    ...
    {loading? <ControlledBackdrop open={loading}/> : (
      <>
        ...
        <ControlledModal open={isOpenModal} onClose={closeModal}  title={`${operationType} Subject`}>
          <SubjectForm
          onClick={closeModal} 
